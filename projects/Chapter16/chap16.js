...
function askQuestion(questionNumber) {
    ...
    switch (questionNumber) {
        ...
        case 2:
            ...
            break;
        case 3:
            question.innerHTML = "Risk my life, or grill gizmo";
            break;
        case 4: 
            question.innerHTML= "Domino, or McDonald" ;
            break;   
        default:
            break;
    }
...
function continueStory(answerNumber) {
    switch (answerNumber) {
        ...
        case 4: 
            if(answers[4]=== "DOMINO") {
                story.innerHTML = document.getElementById("answer41").innerHTML;
                theEnd();
            }else if (answers[4]=== "MCDONALD") {
                story.innerHTML = document.getElementById("answer42").innerHTML;
                theEnd();
